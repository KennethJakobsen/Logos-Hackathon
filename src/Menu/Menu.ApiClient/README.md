# Menu.Client - the C# library for the Menu.Api
...
```
nuget pack -Build -OutputDirectory out Menu.Client.csproj
```
...
------------ | ------------- | ------------- | -------------
*MenuApiApi* | [**GetMenuAllItems**](docs/MenuApiApi.md#getmenuallitems) | **GET** /Menu | 
