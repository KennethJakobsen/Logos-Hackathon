# Gateway.ApiClient - the C# library for the Gateway
...
```
nuget pack -Build -OutputDirectory out Gateway.ApiClient.csproj
```
...
------------ | ------------- | ------------- | -------------
*GatewayApi* | [**CreatMenuItem**](docs/GatewayApi.md#creatmenuitem) | **POST** /Menu/{id} | 
*GatewayApi* | [**GetAlleMenuItems**](docs/GatewayApi.md#getallemenuitems) | **GET** /Menu | 


<a id="documentation-for-models"></a>
## Documentation for Models

 - [Model.CreateMenuItemRequest](docs/CreateMenuItemRequest.md)
